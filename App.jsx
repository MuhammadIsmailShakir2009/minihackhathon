...
import AdmissForm from './Screens/Compo/Admission/AdmisForm/AdmissForm'
import Payment from './Screens/Compo/payment/payment'
  ...
  return (
    <Routes>
      ...
      <Route element={<DashAuth/> }>
        ...
        <Route path='examResultSheet' element={<AdmissForm/>}/>
        <Route path='examResultSheet' element={<Payment/>}/>
