    ...
    <div className='container ' >
        <div className='row'>
            <div className='col col-12 col-md-6 col-lg-6 col-xl-6'>
                <br /><br /> <br /> <br /> 
                <h1 className='display-4 fw-bold' style={{color:"	 #800000"}}>
                The Jetal Hotel Management System
                </h1>
                <p className='fs-2' style={{color:"	#800000"}}> Provide excellent customer service and ensure customer satisfaction.</p>
            </div> 
            <div className='col col-12 col-md-6 col-lg-6 col-xl-6'>
      ...
      <div className='row'>
            <div className='col col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6'>
                    <button  onClick={handleGoogle} className="submit-button2 logingoogle">
                        <img style={{width: "15px"}} src={icon}></img> Login with Google 
                    </button>
            </div> <br /><br /> 
            <div className='col col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6'>
