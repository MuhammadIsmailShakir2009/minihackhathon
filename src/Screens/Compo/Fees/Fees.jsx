...
const Fees = () => {
  ...
  <div style={{backgroundColor:"green"}} class="border border-black accordion-item">
    <h2 class="accordion-header" id="flush-headingSix">
      <button style={{color:"white",backgroundColor:"black"}} class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseSix" aria-expanded="false" aria-controls="flush-collapseSix">
      Payment Management
      </button>
    </h2>
